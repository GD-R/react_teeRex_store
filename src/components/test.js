...
// // console.log(filterKeys.every((key) => selected[key].includes(data[0][key])))

// const res = data.filter((product) => {
//       if ( gender.includes(product.gender) && type.includes(product.type)) {
//           return true
//       }
// })
...
let obj = Object.assign({},
 ...
 const result = data.filter((product) => {
    ...
    return filterKeys.every((key) => {
     ...
     if(flag === true &&  obj[key].includes(product[key])) {
      flag = true
     } 
...
// let check = obj.price.forEach((item) => {
//   if(data[3].price >= item[0] && data[3].price <= item[1]) 
//    return true
// })

// const check = obj.price.map((item) => data[0].price >= item[0] && data[0].price <= item[1])
